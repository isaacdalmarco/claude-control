...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      // Chromium throttles timers in hidden or occluded windows to about once a
      // minute. A dashboard that only polls while you are looking at it cannot
      // tell you a session needs you.
