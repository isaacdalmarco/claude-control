...
// showBranch is for sessions that own their checkout. Sessions sharing a repo all
// report the same branch, where it labels the repo rather than the session.
export function GitSummary({ git, showBranch }: { git: GitSummaryType; showBranch?: boolean }) {
