          ...
          <div className="flex items-center gap-1.5">
            <div className="flex items-center bg-zinc-900/80 border border-zinc-800/50 rounded-lg titlebar-no-drag">
              <button
                ...
                className={`has-tooltip flex items-center justify-center w-8 h-8 rounded-l-lg transition-colors ${viewMode === "list" ? "text-zinc-200 bg-zinc-800" : "text-zinc-600 hover:text-zinc-400"}`}
              ...
              <button
                ...
                className={`has-tooltip flex items-center justify-center w-8 h-8 rounded-r-lg transition-colors ${viewMode === "grid" ? "text-zinc-200 bg-zinc-800" : "text-zinc-600 hover:text-zinc-400"}`}
